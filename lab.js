...
const callie = new Cat ('callie', '12','black');
...
class Wizard{
 ...
 const snape = new Wizard ('snape', 'tall', 'scary spell');
...
const phone1 = new Phone ('Apple', 'iPhone 11', 720, 'black', 700 )
const phone2 = new Phone ('Samsung', 'Galaxy', 500, 'blue', 800 )
const phone3 = new Phone ('Google', 'Pixle', 850, 'white', 1000 )
...
const infoForHelen = {...contactInfo, ...shippingInfo}
console.log(infoForHelen)
